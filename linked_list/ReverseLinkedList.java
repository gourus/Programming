...
/**
 * 
 * This class contains the reversing the Linked list and also the revresal of
 * given range blocks.
 * 
 * 
 * @author sgouru
...
public class ReverseLinkedList extends SingleLinkedList {
	...
	public Node reverseKNodesInList(Node head, int k) {
		...
		/*
		 * This code help us to iterate the list to K nodes or until we reach the end of
		 * the list. And while iterating it changes the links to point backwords.
		 */
